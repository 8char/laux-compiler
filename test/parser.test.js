...
describe("Parser", () => {
  ...
  describe("#mutation statements", () => {
    ...
    it(
      "parses subtraction mutation",
      mutationStatementTests.subtractionMutation,
    );
    it(
      "parses multiplication mutation",
      mutationStatementTests.multiplicationMutation,
    );
    ...
    it(
      "parses shortcircuit or mutation",
      mutationStatementTests.shortcircuitOrMutation,
    );
    it(
      "parses concatenation mutation",
      mutationStatementTests.concatenationMutation,
    );
  });
  ...
  describe("#shortcut expressions", () => {
    ...
    it(
      "parses continueif expression",
      shortcutExpressions.continueifExpression,
    );
  });
